...
object UiTexts {
    ...
    object Tutorials {
        ...
        val Act1c1_5 = SbText("You've made great progress in Verdant Groves! Now, it's time to venture even deeper. Click on the level icon to continue your journey through the lush and mysterious forest. Good luck, brave adventurer!", "Вы добились больших успехов в Verdant Groves! Теперь пришло время рискнуть еще глубже. Нажмите на значок уровня, чтобы продолжить свое путешествие по пышному и загадочному лесу. Удачи, отважный искатель приключений!")
        ...
        object CharacterScreen {
            ...
            val S17 = SbText("Don't forget to explore the detailed description of each ability. This way, you can harness their full potential and witness their incredible growth as Valerian becomes more powerful.", "Не забудьте изучить подробное описание каждой способности. Таким образом, вы сможете использовать весь их потенциал и стать свидетелем их невероятного роста по мере того, как Валериан становится все более могущественным.")
        ...
        object A1C1 {
            ...
            val T4 = SbText("Thorned Crawler character - This is your enemy. You must strategically use your skills to defeat the crawler.", "Шипастый Ползун — это ваш враг. Вы должны стратегически использовать свои навыки, чтобы победить Тернового Охотника.")
